...
const TOOLS = [
  ...
  {id:'jwt-decoder', icon:'🔐', key:'jwtDecode', cat:'dev', ready:true, url:'tools/jwt-decoder.html', tags:'jwt,token,decode,authentication'},
  {id:'html-preview', icon:'📄', key:'htmlPrev', cat:'dev', ready:true, url:'tools/html-preview.html', tags:'html,live,preview,editor,render'},
  {id:'code-formatter', icon:'🧹', key:'codeFmt', cat:'dev', ready:true, url:'tools/code-formatter.html', tags:'code,formatter,beautifier,json,html,css,js'},
  {id:'css-animation', icon:'🔄', key:'cssAnim', cat:'design', ready:true, url:'tools/css-animation.html', tags:'css,animation,generator,keyframes'},
  {id:'cron-generator', icon:'⏰', key:'cronGen', cat:'dev', ready:true, url:'tools/cron-generator.html', tags:'cron,schedule,expression,generator'},
  {id:'whois-lookup', icon:'🌐', key:'whois', cat:'network', ready:true, url:'tools/whois-lookup.html', tags:'whois,domain,registrar,lookup'},
  {id:'ssl-checker', icon:'🔒', key:'sslCheck', cat:'security', ready:true, url:'tools/ssl-checker.html', tags:'ssl,tls,certificate,checker,https'},
  {id:'image-to-base64', icon:'🖼️', key:'imgB64', cat:'dev', ready:true, url:'tools/image-to-base64.html', tags:'image,base64,converter,data-uri'},
  {id:'csv-editor', icon:'📊', key:'csvEdit', cat:'dev', ready:true, url:'tools/csv-editor.html', tags:'csv,editor,table,viewer,spreadsheet'},
  {id:'subnet-calculator', icon:'🔢', key:'subnet', cat:'network', ready:true, url:'tools/subnet-calculator.html', tags:'subnet,calculator,network,cidr,ip'},
...
// ── Category Tabs (buttons in HTML, JS handles click + hash) ──
function initCategoryTabs(){
  ...
  // URL hash support (e.g. #dev, #finance)
