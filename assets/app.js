...
const LANG = {
  en: {
    ...
    heroDesc: '50+ free online tools for developers, designers, and everyone. IP lookup, JSON formatter, investment calculator, and more. Constantly updated.',
  ...
  zh: {
    ...
    heroDesc: '50+ 免费在线工具：IP查询、JSON格式化、投资计算器、密码生成器等等，持续更新中',
